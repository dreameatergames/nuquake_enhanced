...
typedef void (*FloatParseFunc)(GLfloat* __restrict out, const GLubyte* __restrict in);
typedef void (*ByteParseFunc)(GLubyte* __restrict out, const GLubyte* __restrict in);
typedef void (*PolyBuildFunc)(Vertex* __restrict first, Vertex* __restrict previous, Vertex* __restrict vertex, Vertex* __restrict next, const GLsizei i);
...
static void _readVertexData3f3f(const float* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = input[2];
...
static void _readVertexData1i3f(const GLuint* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        int inp = *input;
...
/* VE == VertexExtra */
static void _readVertexData3f3fVE(const float* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = input[2];
...
static void _readVertexData3us3f(const GLushort* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = input[2];
...
static void _readVertexData3us3fVE(const GLushort* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = input[2];
...
static void _readVertexData3ui3f(const GLuint* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = input[2];
...
static void _readVertexData3ui3fVE(const GLuint* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = input[2];
...
static void _readVertexData3ub3f(const GLubyte* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
...
static void _readVertexData3ub3fVE(const GLubyte* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    const float ONE_OVER_TWO_FIVE_FIVE = 1.0f / 255.0f;
    ITERATE(count) {
        output[0] = input[0] * ONE_OVER_TWO_FIVE_FIVE;
        output[1] = input[1] * ONE_OVER_TWO_FIVE_FIVE;
...
static void _readVertexData2f2f(const float* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
...
static void _readVertexData2f2fVE(const float* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
...
static void _readVertexData2f3f(const float* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = 0.0f;
...
static void _readVertexData2ub3f(const GLubyte* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    const float ONE_OVER_TWO_FIVE_FIVE = 1.0f / 255.0f;
    ITERATE(count) {
        output[0] = input[0] * ONE_OVER_TWO_FIVE_FIVE;
        output[1] = input[1] * ONE_OVER_TWO_FIVE_FIVE;
...
static void _readVertexData2us3f(const GLushort* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = 0.0f;
...
static void _readVertexData2us2f(const GLushort* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
...
static void _readVertexData2us2fVE(const GLushort* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
...
static void _readVertexData2ui2f(const GLuint* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
...
static void _readVertexData2ui2fVE(const GLuint* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
...
static void _readVertexData2ub2f(const GLubyte* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    const float ONE_OVER_TWO_FIVE_FIVE = 1.0f / 255.0f;
    ITERATE(count) {
        output[0] = input[0] * ONE_OVER_TWO_FIVE_FIVE;
        output[1] = input[1] * ONE_OVER_TWO_FIVE_FIVE;
...
static void _readVertexData2ub2fVE(const GLubyte* __restrict input, GLuint count, GLubyte stride, GLfloat* __restrict output) {
    const float ONE_OVER_TWO_FIVE_FIVE = 1.0f / 255.0f;
    ITERATE(count) {
        output[0] = input[0] * ONE_OVER_TWO_FIVE_FIVE;
        output[1] = input[1] * ONE_OVER_TWO_FIVE_FIVE;
...
static void _readVertexData2ui3f(const GLuint* __restrict input, GLuint count, GLubyte stride, float* __restrict output) {
    ITERATE(count) {
        output[0] = input[0];
        output[1] = input[1];
        output[2] = 0.0f;
...
static void _readVertexData4ubARGB(const GLubyte* __restrict input, GLuint count, GLubyte stride, GLubyte* __restrict output) {
    ITERATE(count) {
...
static void _readVertexData4fARGB(const float* __restrict input, GLuint count, GLubyte stride, GLubyte* __restrict output) {
    ITERATE(count) {
...
static void _readVertexData3fARGB(const float* __restrict input, GLuint count, GLubyte stride, GLubyte* __restrict output) {
    ITERATE(count) {
        output[R8IDX] = (GLubyte) clamp(input[0] * 255.0f, 0, 255);
        output[G8IDX] = (GLubyte) clamp(input[1] * 255.0f, 0, 255);
        output[B8IDX] = (GLubyte) clamp(input[2] * 255.0f, 0, 255);
...
static void _readVertexData3ubARGB(const GLubyte* __restrict input, GLuint count, GLubyte stride, GLubyte* __restrict output) {
    ITERATE(count) {
        output[R8IDX] = input[0];
        output[G8IDX] = input[1];
        output[B8IDX] = input[2];
...
static void _readVertexData4ubRevARGB(const GLubyte* __restrict input, GLuint count, GLubyte stride, GLubyte* __restrict output) {
    ITERATE(count) {
...
static void _readVertexData4fRevARGB(const float* __restrict input, GLuint count, GLubyte stride, GLubyte* __restrict output) {
    ITERATE(count) {
...
GL_FORCE_INLINE void _readPositionData(const GLuint first, const GLuint count, Vertex* __restrict output) {
    const GLubyte vstride = (VERTEX_POINTER.stride) ? VERTEX_POINTER.stride : VERTEX_POINTER.size * byte_size(VERTEX_POINTER.type);
    const void* __restrict vptr = ((GLubyte*) VERTEX_POINTER.ptr + (first * vstride));
...
static void generate(SubmissionTarget* target, const GLenum mode, const GLsizei first, const GLuint count,
        const GLubyte* __restrict indices, const GLenum type, const GLboolean doTexture, const GLboolean doMultitexture, const GLboolean doLighting) {
    ...
    if(!indices) {
        ...
        Vertex* __restrict start = _glSubmissionTargetStart(target);

        if(FAST_PATH_ENABLED) {
            /* Copy the pos, uv and color directly in one go */
            const GLubyte* pos = (GLubyte*)VERTEX_POINTER.ptr;
            uint32_t *flags_ptr = (uint32_t*)(VERTEX_POINTER.ptr)-1;
            Vertex* it = start;
            if(*flags_ptr == 0){
                ITERATE(count) {
                ...
                sq_cpy(start, flags_ptr, count * sizeof(Vertex) );
                return;
            }
        } else {
            //printf("slowpath hit\n");
...
static void mat_transform3(const float* xyz, const float* xyzOut, const uint32_t count, const uint32_t inStride, const uint32_t outStride) {
    uint8_t* __restrict dataIn = (uint8_t*) xyz;
    uint8_t* __restrict dataOut = (uint8_t*) xyzOut;

    ITERATE(count) {
        float* __restrict in = (float*) dataIn;
        float* __restrict out = (float*) dataOut;
...
GL_FORCE_INLINE void submitVertices(GLenum mode, GLsizei first, GLuint count, GLenum type, const GLvoid* indices) {
    ...
    if(!_glIsDirectBufferEnabled()){
        ...
        target->header_offset = target->output->vector.size-count-1;
        target->start_offset = target->header_offset + 1;
    }
...
void APIENTRY glDirectBufferReserve_INTERNAL_KOS(int count, int* buffer_ptr, GLenum mode){
    if(!_glIsDirectBufferEnabled())
        return;
    ...
    PolyList *list = _glActivePolyList();

    int prev_size = list->vector.size;

    /* Make room for the vertices and header */
    aligned_vector_extend(&(list->vector), ((mode == GL_TRIANGLE_FAN) ? ((count - 2) * 3) : count) + 1);

    *buffer_ptr = (int)(aligned_vector_at(&(list->vector), prev_size+1));
}
