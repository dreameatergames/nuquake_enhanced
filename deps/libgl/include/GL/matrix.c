...
void gluLookAt(GLfloat eyex, GLfloat eyey, GLfloat eyez, GLfloat centerx,
    ...
    RETURN_VECTOR_STRUCT ret = MATH_Cross_Product(f[0], f[1], f[2], u[0], u[1], u[2]);
    vec3f_normalize_sh4(&ret.z1);
    s[0] = ret.z1;
    s[1] = ret.z2;
    s[2] = ret.z3;
    ret = MATH_Cross_Product(s[0], s[1], s[2], f[0], f[1], f[2]);
    
    m[0] =  s[0]; m[4] =  s[1]; m[8] =   s[2]; m[12] = 0.0f;
	m[1] =  ret.z1; m[5] =  ret.z2; m[9] =   ret.z3; m[13] = 0.0f;
