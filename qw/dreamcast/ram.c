...
static unsigned long usedRam = 0x00000000;
...
#if defined(__DREAMCAST__)
    struct mallinfo mi = mallinfo();
    systemRam = 16 * 1024 * 1024;  // Total physical RAM
    usedRam = mi.arena;            // Get actual allocated arena size
    stackSize = mi.uordblks;       // Get actual used blocks
#elif PSP
